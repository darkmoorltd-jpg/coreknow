...
const ROWS = [
  ...
  { icon: "people-circle-outline", label: "Study Groups", route: "/social/groups", color: colors.accent },
  { icon: "chatbubbles-outline", label: "Ask a Peer", route: "/social/forum", color: colors.cyan },
  { icon: "person-add-outline", label: "Friends", route: "/social/friends", color: colors.green },
  { icon: "trophy-outline", label: "Challenges", route: "/social/challenges", color: colors.yellow },
  ...
  { icon: "school-outline", label: "School Hub", route: "/school/hub", color: colors.accent },
  { icon: "shield-checkmark-outline", label: "Admin Panel", route: "/admin", color: colors.red },
